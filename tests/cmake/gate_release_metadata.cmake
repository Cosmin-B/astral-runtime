...
file(WRITE "${out_dir}/logs/comment-review.tsv" "decision\tissue\tnotes\tpath\tline\tkind\tmarker\treference\ttext\n")
...
"{
  ...
  \"evidence\": {
    ...
    \"unreal_57_full_container\": {
      \"status\": \"pass\",
      \"command\": \"./scripts/run_unreal_container_ci.sh --variant full --image ghcr.io/epicgames/unreal-engine:dev-5.7.4 --digest sha256:582895c09ada64db1f3e46053afe29e4fdd0d55da53d60b7b29741f6ecfb34ce --filter AstralRT --install-cmake\",
      \"artifacts\": [\"logs/unreal-57-full-container.log\"]
    },
    \"unreal_57_slim_container\": {
      \"status\": \"pass\",
      \"command\": \"ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1 ASTRAL_UNREAL_REQUIRE_REAL_LIFECYCLE=1 ASTRAL_UNREAL_TEST_EMBED_MODEL=/workspace/astral/tests/models/Qwen3-Embedding-0.6B-Q8_0.gguf ASTRAL_UNREAL_REQUIRE_REAL_EMBEDDING=1 ./scripts/run_unreal_container_ci.sh --variant slim --image ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4 --digest sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6 --filter AstralRT --skip-native-build\",
      \"artifacts\": [\"logs/unreal-57-slim-container.log\"]
    },
    \"unreal_compatibility_matrix\": {
      \"status\": \"pass\",
      \"command\": \"ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/gemma-3-270m-q4_k_m.gguf ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1 UNREAL_54_EDITOR=... UNREAL_55_EDITOR=... UNREAL_56_EDITOR=... UNREAL_57_EDITOR=... ./scripts/run_unreal_compatibility_matrix.sh --versions '5.4 5.5 5.6 5.7' --filter AstralRT\",
      \"artifacts\": [\"logs/unreal-compatibility-matrix.log\"]
    },
    \"unreal_sample_package\": {
      \"status\": \"pass\",
      \"command\": \"UNREAL_RUNUAT=/opt/UE_5.7/Engine/Build/BatchFiles/RunUAT.sh ./scripts/run_unreal_sample_package.sh --platform Linux --run-sample --runtime-log build/unreal-sample-package/runtime.log --sample-model /workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf --sample-embedding-model /workspace/astral/tests/models/Qwen3-Embedding-0.6B-Q8_0.gguf --sample-memory-backend mock --sample-media-backend mock\",
      \"artifacts\": [\"logs/unreal-sample-package.log\", \"logs/unreal-sample-runtime.log\"]
    },
    \"unity_editmode_abi\": {
      \"status\": \"pass\",
      \"command\": \"./scripts/run_unity_gameci_tests.sh --image unityci/editor:ubuntu-6000.0.57f1-base-3.2.2\",
