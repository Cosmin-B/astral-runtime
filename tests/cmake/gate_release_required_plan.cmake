...
if(NOT good_output MATCHES "Unreal native package: cmake --preset unreal-plugin && cmake --build --preset unreal-plugin -j")
  message(FATAL_ERROR "run_release_required_gates.sh --print-plan did not require the host Unreal package build: ${good_output}")
endif()
if(NOT good_output MATCHES "Unreal UE 5[.]7 full container: scripts/run_unreal_container_ci\\.sh --variant full --filter AstralRT --skip-native-build")
