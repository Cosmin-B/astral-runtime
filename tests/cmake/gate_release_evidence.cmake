...
file(WRITE "${evidence_dir}/logs/comment-review.tsv" "decision\tissue\tnotes\tpath\tline\tkind\tmarker\treference\ttext\n")
...
foreach(lane IN LISTS required_lanes)
  ...
  elseif(lane STREQUAL "unreal_57_slim_container")
    ...
    set(command "ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1 ASTRAL_UNREAL_REQUIRE_REAL_LIFECYCLE=1 ASTRAL_UNREAL_TEST_EMBED_MODEL=/workspace/astral/tests/models/Qwen3-Embedding-0.6B-Q8_0.gguf ASTRAL_UNREAL_REQUIRE_REAL_EMBEDDING=1 ./scripts/run_unreal_container_ci.sh --variant slim --image ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4 --digest sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6 --filter AstralRT --skip-native-build")
  elseif(lane STREQUAL "unreal_compatibility_matrix")
    set(artifacts "[\"logs/unreal-compatibility-matrix.log\"]")
    set(command "ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/gemma-3-270m-q4_k_m.gguf ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1 UNREAL_54_EDITOR=... UNREAL_55_EDITOR=... UNREAL_56_EDITOR=... UNREAL_57_EDITOR=... ./scripts/run_unreal_compatibility_matrix.sh --versions '5.4 5.5 5.6 5.7' --filter AstralRT")
  elseif(lane STREQUAL "unreal_sample_package")
    set(artifacts "[\"logs/unreal-sample-package.log\", \"logs/unreal-sample-runtime.log\"]")
    set(command "UNREAL_RUNUAT=/opt/UE_5.7/Engine/Build/BatchFiles/RunUAT.sh ./scripts/run_unreal_sample_package.sh --platform Linux --run-sample --runtime-log build/unreal-sample-package/runtime.log --sample-model /workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf --sample-embedding-model /workspace/astral/tests/models/Qwen3-Embedding-0.6B-Q8_0.gguf --sample-memory-backend mock --sample-media-backend mock")
  elseif(lane STREQUAL "unity_editmode_abi")
    set(command "./scripts/run_unity_gameci_tests.sh --image unityci/editor:ubuntu-6000.0.57f1-base-3.2.2")
...
set(bad_unreal_real_model_manifest "${out_dir}/bad-unreal-real-model-evidence.json")
file(READ "${good_manifest}" bad_unreal_real_model_text)
file(WRITE "${bad_unreal_real_model_manifest}" "${bad_unreal_real_model_text}")
file(WRITE "${evidence_dir}/logs/unreal-57-slim-container.log" "[unreal_container] Check image access: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Pull image: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Local image digests:\nghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Image: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Test filter: AstralRT\n[unreal_container] Linux SDK: /UnrealEngine/Engine/Config/Linux/Linux_SDK.json\nv26 clang 20.1.8\n[unreal_container] clang:\nclang version 20.1.8\n-- Unreal ThirdParty provenance OK: libastral_rt.a\n[unreal_ci] Filter: AstralRT\nLogAutomationCommandLine: Display: Found 18 automation tests based on 'AstralRT'\nLogAutomationCommandLine: Display: \tAstralRT.Module.ShutdownRestart\nLogAutomationCommandLine: Display: \tAstralRT.Module.EnginePreExit\nLogAutomationCommandLine: Display: \tAstralRT.Module.EndPIE\nLogAstralRT: AstralRT: Shutdown (EnginePreExit)\n[unreal-results] OK: build/unreal-ci-results/unreal-automation.log\n")

execute_process(
  COMMAND "${ASTRAL_PYTHON_EXECUTABLE}" "${ASTRAL_SOURCE_DIR}/scripts/validate_release_evidence.py" "${bad_unreal_real_model_manifest}" --base-dir "${evidence_dir}"
  WORKING_DIRECTORY "${ASTRAL_SOURCE_DIR}"
  RESULT_VARIABLE bad_unreal_real_model_result
  ERROR_VARIABLE bad_unreal_real_model_error
)
if(bad_unreal_real_model_result EQUAL 0)
  message(FATAL_ERROR "validate_release_evidence.py accepted UE 5.7 slim evidence without real-model markers")
endif()
if(NOT bad_unreal_real_model_error MATCHES "AstralRT.Real.GenerationSmoke")
  message(FATAL_ERROR "validate_release_evidence.py failed for the wrong Unreal real-model artifact reason: ${bad_unreal_real_model_error}")
endif()
file(WRITE "${evidence_dir}/logs/unreal-57-slim-container.log" "[unreal_container] Check image access: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Pull image: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Local image digests:\nghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Image: ghcr.io/epicgames/unreal-engine:dev-slim-5.7.4@sha256:5d8fa43dbbc07ea53e6474c0f3ac33af092cc264070b0985a2d3e8c4697940f6\n[unreal_container] Test filter: AstralRT\n[unreal_container] Linux SDK: /UnrealEngine/Engine/Config/Linux/Linux_SDK.json\nv26 clang 20.1.8\n[unreal_container] clang:\nclang version 20.1.8\n-- Unreal ThirdParty provenance OK: libastral_rt.a\n[unreal_ci] Filter: AstralRT\nLogAutomationCommandLine: Display: Found 18 automation tests based on 'AstralRT'\nLogAutomationCommandLine: Display: \tAstralRT.Module.ShutdownRestart\nLogAutomationCommandLine: Display: \tAstralRT.Module.EnginePreExit\nLogAutomationCommandLine: Display: \tAstralRT.Module.EndPIE\nLogAutomationCommandLine: Display: \tAstralRT.Real.GenerationSmoke\nLogAutomationCommandLine: Display: \tAstralRT.Real.SessionLifecycle\nLogAutomationCommandLine: Display: \tAstralRT.Real.EmbeddingProbe\nLogAstralRT: Display: [unreal_generation_smoke] backend=cpu model=/workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf bytes=37 text=Paris. The capital of France is also\nLogAstralRT: Display: [unreal_session_lifecycle] backend=cpu model=/workspace/astral/tests/models/Qwen3-0.6B-Q8_0.gguf cancel_wait=-7 canceled_bytes=0 reuse_wait=0 reuse_bytes=37 text=Paris. The capital of France is also\nLogAstralRT: Display: [unreal_embedding_probe] backend=cpu model=/workspace/astral/tests/models/Qwen3-Embedding-0.6B-Q8_0.gguf dim=1024 sum_abs=2083.470069 first=-0.338817\nLogAstralRT: AstralRT: Shutdown (EnginePreExit)\n[unreal-results] OK: build/unreal-ci-results/unreal-automation.log\n")
...
string(REPLACE
  "ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/gemma-3-270m-q4_k_m.gguf ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1 UNREAL_54_EDITOR=... UNREAL_55_EDITOR=... UNREAL_56_EDITOR=... UNREAL_57_EDITOR=... ./scripts/run_unreal_compatibility_matrix.sh --versions '5.4 5.5 5.6 5.7' --filter AstralRT"
...
set(bad_unreal_matrix_real_artifact_manifest "${out_dir}/bad-unreal-matrix-real-artifact-evidence.json")
file(READ "${good_manifest}" bad_unreal_matrix_real_artifact_text)
file(WRITE "${bad_unreal_matrix_real_artifact_manifest}" "${bad_unreal_matrix_real_artifact_text}")
file(WRITE "${evidence_dir}/logs/unreal-compatibility-matrix.log" "[unreal_matrix] UE 5.4: /opt/UE_5.4/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.4/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.4/unreal-automation.log\n[unreal_matrix] UE 5.5: /opt/UE_5.5/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.5/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.5/unreal-automation.log\n[unreal_matrix] UE 5.6: /opt/UE_5.6/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.6/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.6/unreal-automation.log\n[unreal_matrix] UE 5.7: /opt/UE_5.7/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.7/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.7/unreal-automation.log\n")

execute_process(
  COMMAND "${ASTRAL_PYTHON_EXECUTABLE}" "${ASTRAL_SOURCE_DIR}/scripts/validate_release_evidence.py" "${bad_unreal_matrix_real_artifact_manifest}" --base-dir "${evidence_dir}"
  WORKING_DIRECTORY "${ASTRAL_SOURCE_DIR}"
  RESULT_VARIABLE bad_unreal_matrix_real_artifact_result
  ERROR_VARIABLE bad_unreal_matrix_real_artifact_error
)
if(bad_unreal_matrix_real_artifact_result EQUAL 0)
  message(FATAL_ERROR "validate_release_evidence.py accepted UE 5.4 compatibility evidence without a real generation marker")
endif()
if(NOT bad_unreal_matrix_real_artifact_error MATCHES "UE 5[.]4 log is missing AstralRT.Real.GenerationSmoke")
  message(FATAL_ERROR "validate_release_evidence.py failed for the wrong UE 5.4 real-model compatibility reason: ${bad_unreal_matrix_real_artifact_error}")
endif()
file(WRITE "${evidence_dir}/logs/unreal-compatibility-matrix.log" "[unreal_matrix] UE 5.4: /opt/UE_5.4/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.4/automation-report\nLogAutomationCommandLine: Display: \tAstralRT.Real.GenerationSmoke\nLogAstralRT: Display: [unreal_generation_smoke] backend=cpu model=/workspace/astral/tests/models/gemma-3-270m-q4_k_m.gguf bytes=38 text=the capital of the country of France.\n[unreal-results] OK: build/unreal-ci-results/ue-5.4/unreal-automation.log\n[unreal_matrix] UE 5.5: /opt/UE_5.5/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.5/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.5/unreal-automation.log\n[unreal_matrix] UE 5.6: /opt/UE_5.6/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.6/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.6/unreal-automation.log\n[unreal_matrix] UE 5.7: /opt/UE_5.7/Engine/Binaries/Linux/UnrealEditor-Cmd\n[unreal_ci] Filter: AstralRT\n[unreal_ci] Report: build/unreal-ci-results/ue-5.7/automation-report\n[unreal-results] OK: build/unreal-ci-results/ue-5.7/unreal-automation.log\n")
...
file(WRITE "${evidence_dir}/logs/comment-review.tsv" "path\tline\tkind\tmarker\treference\ttext\n")
execute_process(
  COMMAND "${ASTRAL_PYTHON_EXECUTABLE}" "${ASTRAL_SOURCE_DIR}/scripts/validate_release_evidence.py" "${good_manifest}" --base-dir "${evidence_dir}"
  WORKING_DIRECTORY "${ASTRAL_SOURCE_DIR}"
...
foreach(required
  ...
  "ASTRAL_UNREAL_TEST_MODEL=/workspace/astral/tests/models/gemma-3-270m-q4_k_m.gguf"
  "ASTRAL_UNREAL_REQUIRE_REAL_GENERATION=1"
  "5.4 5.5 5.6 5.7"
  "--filter AstralRT"
  "unreal_sample_package"
