...
file(GLOB_RECURSE unreal_sample_template_files
  "${ASTRAL_SOURCE_DIR}/examples/unreal/AstralSample/*")
foreach(unreal_sample_template_file IN LISTS unreal_sample_template_files)
  if(NOT IS_DIRECTORY "${unreal_sample_template_file}")
    file(READ "${unreal_sample_template_file}" unreal_sample_template_text)
    string(APPEND unreal_sample_script_text "\n${unreal_sample_template_text}")
  endif()
endforeach()
...
foreach(required_unreal_lifecycle_text
    ...
    "stale model remains invalid after runtime restart"
    "session recreate clears stale generation handle"
    "embedder recreate clears stale generation handle"
