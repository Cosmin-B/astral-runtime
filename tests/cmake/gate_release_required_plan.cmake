...
if(NOT good_output MATCHES "memory search recall: scripts/run_memory_search_acceptance\\.sh .*--capacity 10000.*--graph-search 256.*--query-search 256.*--min-recall-pct 99.*--recall-storages f32,q8,q8f32,f6e3m2f32,f8e5m2f32")
  message(FATAL_ERROR "run_release_required_gates.sh --print-plan did not require the 99 percent memory-search recall lane: ${good_output}")
endif()
