...
- `gate_cuda_parity_runner`: checks that CUDA parity runners require real inference/e2e flags and GPU/toolkit runner visibility unless probe-only mode is explicit.
