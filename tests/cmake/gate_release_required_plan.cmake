...
if(NOT good_output MATCHES "Unreal UE 5[.]7 full container: scripts/run_unreal_container_ci\\.sh --variant full --filter AstralRT[.][*]")
  message(FATAL_ERROR "run_release_required_gates.sh --print-plan did not require the Unreal full container lane: ${good_output}")
endif()
if(NOT good_output MATCHES "Unreal UE 5[.]7 slim container: scripts/run_unreal_container_ci\\.sh --variant slim --filter AstralRT[.][*]")
