...
| UE 5.7 sample package and runtime smoke | `UNREAL_RUNUAT=... ./scripts/run_unreal_sample_package.sh --platform Linux --run-sample --runtime-log build/unreal-sample-package/runtime.log --sample-model ... --sample-embedding-model ... --sample-memory-backend mock` | Yes |
