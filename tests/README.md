...
- `gate_unreal_validation_access`: checks the fast Unreal access readiness probe for missing access, cached UE 5.7 containers, UE 5.4-5.7 slim cache diagnostics, readable Epic GHCR manifests, and executable UE 5.4-5.7 editor paths.
